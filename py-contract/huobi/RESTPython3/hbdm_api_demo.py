...
ACCESS_KEY = 'xa2b53ggfc-0ba86dc2-017015d1-39948'
SECRET_KEY = '05deab92-34c5bba7-7baef737-e8c17'
...
# print (u' 合约下单 ')
pprint(dm.send_contract_order(symbol='', contract_type='quarter', contract_code='', 
